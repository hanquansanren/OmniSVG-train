...
DATA_DIR="/data/phd23_weiguang_zhang/works/svg/my_lis2_1"
...
RESUME_CHECKPOINT="/data/phd23_weiguang_zhang/works/svg/models--OmniSVG--OmniSVG1.1_4B/snapshots/e4d03a89aaa28468520b45dc2541098102264d4e/pytorch_model.bin"
...
TRAIN_CONFIG_FILE="train_config_code_complement.yaml"

# Accelerate config file (for DeepSpeed, FSDP, etc.)
# 多卡训练建议使用 FSDP 配置；如果要退回默认 accelerate 行为，可置空。
